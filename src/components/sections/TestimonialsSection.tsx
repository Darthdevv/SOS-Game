  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
        ...
        >
          <h1 className="text-sm text-gray-400 uppercase tracking-widest mb-2">
            What people think?
          </h1>
          ...
          {quotes.map((item, index) => (
            ...
            >
              <div className="flex items-center mb-3">
                ...
                />
                <div>
                  <h3 className="text-yellow-500 font-normal text-2xl">
                    {item.name}
                  </h3>
              ...
              <p className="text-md text-gray-200 my-3">“{item.quote}”</p>
